...
namespace EcmaScript.NET.Types.RegExp
{
    ...
    public class BuiltinRegExp : IdScriptableObject, IFunction
    {
        ...
        internal const sbyte REOP_EMPTY = 0; /* match rest of input against rest of r.e. */
        internal const sbyte REOP_ALT = 1; /* alternative subexpressions in kid and next */
        internal const sbyte REOP_BOL = 2; /* beginning of input (or line if multiline) */
        internal const sbyte REOP_EOL = 3; /* end of input (or line if multiline) */
        internal const sbyte REOP_WBDRY = 4; /* match "" at word boundary */
        internal const sbyte REOP_WNONBDRY = 5; /* match "" at word non-boundary */
        internal const sbyte REOP_QUANT = 6; /* quantified atom: atom{1,2} */
        internal const sbyte REOP_STAR = 7; /* zero or more occurrences of kid */
        internal const sbyte REOP_PLUS = 8; /* one or more occurrences of kid */
        internal const sbyte REOP_OPT = 9; /* optional subexpression in kid */
        internal const sbyte REOP_LPAREN = 10; /* left paren bytecode: kid is u.num'th sub-regexp */
        internal const sbyte REOP_RPAREN = 11; /* right paren bytecode */
        internal const sbyte REOP_DOT = 12; /* stands for any character */
        internal const sbyte REOP_CCLASS = 13; /* character class: [a-f] */
        internal const sbyte REOP_DIGIT = 14; /* match a digit char: [0-9] */
        internal const sbyte REOP_NONDIGIT = 15; /* match a non-digit char: [^0-9] */
        internal const sbyte REOP_ALNUM = 16; /* match an alphanumeric char: [0-9a-z_A-Z] */
        internal const sbyte REOP_NONALNUM = 17; /* match a non-alphanumeric char: [^0-9a-z_A-Z] */
        internal const sbyte REOP_SPACE = 18; /* match a whitespace char */
        internal const sbyte REOP_NONSPACE = 19; /* match a non-whitespace char */
        internal const sbyte REOP_BACKREF = 20; /* back-reference (e.g., \1) to a parenthetical */
        internal const sbyte REOP_FLAT = 21; /* match a flat string */
        internal const sbyte REOP_FLAT1 = 22; /* match a single char */
        internal const sbyte REOP_JUMP = 23; /* for deoptimized closure loops */
        internal const sbyte REOP_DOTSTAR = 24; /* optimize .* to use a single opcode */
        internal const sbyte REOP_ANCHOR = 25; /* like .* but skips left context to unanchored r.e. */
        internal const sbyte REOP_EOLONLY = 26; /* $ not preceded by any pattern */
        internal const sbyte REOP_UCFLAT = 27; /* flat Unicode string; len immediate counts chars */
        internal const sbyte REOP_UCFLAT1 = 28; /* single Unicode char */
        internal const sbyte REOP_UCCLASS = 29; /* Unicode character class, vector of chars to match */
        internal const sbyte REOP_NUCCLASS = 30; /* negated Unicode character class */
        internal const sbyte REOP_BACKREFi = 31; /* case-independent REOP_BACKREF */
        internal const sbyte REOP_FLATi = 32; /* case-independent REOP_FLAT */
        internal const sbyte REOP_FLAT1i = 33; /* case-independent REOP_FLAT1 */
        internal const sbyte REOP_UCFLATi = 34; /* case-independent REOP_UCFLAT */
        internal const sbyte REOP_UCFLAT1i = 35; /* case-independent REOP_UCFLAT1 */
        internal const sbyte REOP_ANCHOR1 = 36; /* first-char discriminating REOP_ANCHOR */
        internal const sbyte REOP_NCCLASS = 37; /* negated 8-bit character class */
        internal const sbyte REOP_DOTSTARMIN = 38; /* ungreedy version of REOP_DOTSTAR */
        internal const sbyte REOP_LPARENNON = 39; /* non-capturing version of REOP_LPAREN */
        internal const sbyte REOP_RPARENNON = 40; /* non-capturing version of REOP_RPAREN */
        internal const sbyte REOP_ASSERT = 41; /* zero width positive lookahead assertion */
        internal const sbyte REOP_ASSERT_NOT = 42; /* zero width negative lookahead assertion */
        internal const sbyte REOP_ASSERTTEST = 43; /* sentinel at end of assertion child */
        internal const sbyte REOP_ASSERTNOTTEST = 44; /* sentinel at end of !assertion child */
        internal const sbyte REOP_MINIMALSTAR = 45; /* non-greedy version of * */
        internal const sbyte REOP_MINIMALPLUS = 46; /* non-greedy version of + */
        internal const sbyte REOP_MINIMALOPT = 47; /* non-greedy version of ? */
        internal const sbyte REOP_MINIMALQUANT = 48; /* non-greedy version of {} */
        internal const sbyte REOP_ENDCHILD = 49; /* sentinel at end of quantifier child */
        internal const sbyte REOP_CLASS = 50; /* character class with index */
        internal const sbyte REOP_REPEAT = 51; /* directs execution of greedy quantifier */
        internal const sbyte REOP_MINIMALREPEAT = 52; /* directs execution of non-greedy quantifier */
        internal const sbyte REOP_END = 53;
